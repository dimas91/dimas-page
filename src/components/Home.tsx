  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      <ul style={{ display: "flex", justifyContent: "space-between", gap: "2em" }}>
        ...
        <li><i className={"fab fa-instagram-square fa-lg"}></i><a href="https://www.instagram.com/dimas91" target="_blank" rel="noreferrer" style={{ padding: "0em .5em" }}>Instagram</a></li>
